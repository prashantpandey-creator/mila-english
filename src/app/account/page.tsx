      ...
      <AppMain width="work" className="account-page__main">
        <div className="account-stack">
          <section className="account-hero">
            <p className="account-hero__kicker">{isGia ? 'YOUR GIA' : T('ТВОЙ MILA', 'YOUR MILA')}</p>
            <h1>{account.isGuest
          ...
          {isGia ? <section className="account-panel">
            ...
            <div className="account-actions">
              {pro || !milaTeacher ? <a className="account-button account-button--primary" href="/pricing">{pro ? T('Посмотреть тариф', 'View plan') : T('Открыть Pro', 'See Mila Pro')}</a> : null}
