  ...
  return (
    <AppShell className="legal-page privacy-page">
      ...
      <article className="legal-page__article">
        ...
        <p style={{fontSize:18,marginTop:30}}>This policy covers the related services at <strong>mila.purangpt.com</strong> (Mila multilingual conversation and structured learning), <strong>gia.purangpt.com</strong> (the Gia text-and-voice companion), and <strong>mia.purangpt.com</strong> (the public travel, language, and culture experience), plus the Mila iOS app and legacy miachat.purangpt.com links. Together they are called the Services below.</p>
        <p>Mia’s public Scene Studio and Mia Talk do not require an account. Scene Studio keeps its most recent scene in your browser. Mia Talk does not save conversation history. Gia, Mia, and Mila have separate product experiences while using related account and service infrastructure behind the scenes.</p>
        ...
        <section>
          <h2>Voice data</h2>
          <p>Pronunciation tools and the private level-assessment path send a recording to Mila only after you tap the microphone. Its speech service uses it to create a transcript, then deletes the recording after the request. The transcript and resulting learning feedback may remain in your learning history.</p>
          <p>The Mila level assessment offers a private server voice path, a written path with no microphone, and a separate optional <strong>Live conversation</strong>. Before Live conversation starts, the Service explains that microphone audio and its transcript will be sent to OpenAI for real-time processing and asks for explicit consent. Nothing is sent to OpenAI from that path unless you agree.</p>
          <p>Gia’s companion voice room currently offers only consented <strong>Live voice</strong> to eligible preview or Pro accounts; its unfinished private/local mode is unavailable. Before Live starts, Gia explains that microphone audio and the transcript will be sent to OpenAI for real-time processing and asks for explicit consent. If you do not agree, you can continue in text chat. Gia asks separately for each page session.</p>
          <p>Mia Talk is an optional anonymous live conversation. Before it starts, Mia explains that microphone audio and its transcript will be sent to OpenAI for real-time processing and asks for explicit consent. Mia does not save the audio, transcript, or conversation history. Audio is never sent to advertising companies.</p>
        ...
        <section>
          ...
          <p>When an account has a payment, Mila may retain a detached record of the payment ID, amount, currency, status, and access period where required for accounting, fraud prevention, refunds, or legal compliance. The local record no longer has a direct relation to the deleted learning profile, but it can remain linkable through processor records where required. YooKassa and other service providers may retain data under their own legal obligations.</p>
        </section>
