...
const LESSON_INSTRUCTIONS = 'You design concise, practical lessons for Mila. English is the only learning target. The learner’s stated native language may be used for short beginner explanations, but never as a replacement target. Return exactly three lessons. Each multiple-choice exercise must contain the correct answer exactly once among its four options.';
