...
export const metadata: Metadata = {
  title: 'Support — Mila',
  description: 'Help for the Mila app.',
}
  ...
  return (
    <AppShell className="legal-page support-page">
      ...
      <article className="legal-page__article">
        ...
        <p className="legal-page__lede">For sign-in, learning, payment, refund, or privacy questions, contact Mila directly.</p>
        ...
        <section className="legal-page__cards">
          {[
            ['The microphone does not start', 'Open your device settings, allow microphone access for Mila, then try again. The app asks only when you start a recording.'],
            ...
            ['I paid but Pro is not active', 'Open Account after a few minutes. Mila activates Pro only after its payment provider confirms the payment. If it is still missing, email the account address, payment date, and amount—never send card details.'],
