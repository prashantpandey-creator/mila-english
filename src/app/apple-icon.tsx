...
export default async function AppleIcon() {
  ...
  return new ImageResponse(
    <div style={{
      ...
      color:'#d9006c',fontFamily:'serif',fontSize:105,fontWeight:700,letterSpacing:'-0.08em',
      border:isGia ? '7px solid #04070a' : '7px solid #faf8f5',
      boxShadow:isGia ? 'inset 0 0 0 2px #ff2e91' : 'inset 0 0 0 2px #a9bab6',
    }}>{isGia ? 'G' : 'M'}</div>,
    size,
  )
}
