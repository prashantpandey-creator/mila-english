        ...
        {result ? (
          <div className="assessment-result__stack">
            <section className="assessment-result__hero">
              ...
              <h1>{T('Mila определила, с чего лучше начать.', 'Mila found your best starting point.')}</h1>
            ...
            <div className="assessment-result__grid">
              ...
              <section className="assessment-result__panel">
                ...
                ) : <p>{result.profile.weak_summary || T('Начни с короткого урока — Mila уточнит фокус по ходу.', 'Start with a short lesson and Mila will refine the focus as you go.')}</p>}
              </section>
            </div>
