...
const BADGES_RU=[{id:'first-lesson',e:'🌸',t:'Первый урок',d:'Пройди свой первый урок'},{id:'three-day-streak',e:'🔥',t:'3 дня подряд',d:'Занимайся три дня без перерыва'},{id:'ten-words',e:'📝',t:'10 слов',d:'Выучи 10 новых слов'},{id:'voice',e:'🎤',t:'Голос',d:'Попрактикуй произношение'},{id:'five-lessons',e:'⭐',t:'5 уроков',d:'Пройди пять уроков'},{id:'perfect-score',e:'🏆',t:'Мастер',d:'Набери 100 очков'}];
const BADGES_EN=[{id:'first-lesson',e:'🌸',t:'First Lesson',d:'Complete your first lesson'},{id:'three-day-streak',e:'🔥',t:'3 Day Streak',d:'Study three days in a row'},{id:'ten-words',e:'📝',t:'10 Words',d:'Learn 10 new words'},{id:'voice',e:'🎤',t:'Voice',d:'Practice pronunciation'},{id:'five-lessons',e:'⭐',t:'5 Lessons',d:'Complete five lessons'},{id:'perfect-score',e:'🏆',t:'Master',d:'Score 100 points'}];
