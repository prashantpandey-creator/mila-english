    ...
    lessons: [
      {
        ...
        difficulty,
        content: `Short ${result.level} grammar practice. Notice the pattern, say the example aloud, then make one personal example. Your Mila teacher can explain it in your native language when needed.`,
