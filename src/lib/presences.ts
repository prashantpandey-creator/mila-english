...
export const MILA_PRESENCES = [
  {
    ...
    name: { en: 'Gia', ru: 'Джиа' },
    description: {
      en: 'Natural portrait in black silk with a soft signal glow.',
      ru: 'Естественный портрет в чёрном шёлке с мягким сигнальным сиянием.',
    },
    medium: { en: 'Cinematic', ru: 'Кинообраз' },
    animated: true,
    poster: '/avatar/presences/mila-v6/avatar.webp',
    expandedPortrait: '/avatar/presences/mila-v6/expanded.webp',
  ...
  },
  {
    ...
    description: {
      en: 'Natural portrait with restrained copper light.',
      ru: 'Естественный портрет со сдержанным медным светом.',
    },
    medium: { en: 'Cinematic', ru: 'Кинообраз' },
    animated: true,
    poster: '/avatar/presences/ember-v6/avatar.webp',
    expandedPortrait: '/avatar/presences/ember-v6/expanded.webp',
    expandedFraming: 'upper-body',
    objectPosition: 'center',
    expandedObjectPosition: 'center 17%',
  },
  {
    ...
    description: {
      en: 'Warm-neutral nocturne with pitch-black flowing hair.',
      ru: 'Ноктюрн в естественных тёпло-нейтральных тонах с длинными иссиня-чёрными волосами.',
    },
    medium: { en: 'Cinematic', ru: 'Кинообраз' },
    animated: true,
    poster: '/avatar/presences/nocturne-v18/avatar.webp',
    expandedPortrait: '/avatar/presences/nocturne-v18/expanded.webp',
    expandedFraming: 'upper-body',
    objectPosition: 'center',
    expandedObjectPosition: 'center 17%',
  },
