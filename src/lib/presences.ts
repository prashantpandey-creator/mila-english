...
export const MILA_PRESENCES = [
  ...
  },
  {
    ...
    medium: { en: 'Cinematic', ru: 'Кинообраз' },
    animated: true,
    poster: '/avatar/presences/nocturne-v15/avatar.webp',
    expandedPortrait: '/avatar/presences/upper-body-v11/nocturne.webp',
  ...
  },
  {
    ...
    medium: { en: 'Cinematic', ru: 'Кинообраз' },
    animated: true,
    poster: '/avatar/presences/aurelia-v1/avatar.webp',
    expandedPortrait: '/avatar/presences/aurelia-v1/expanded.webp',
    expandedFraming: 'upper-body',
    objectPosition: 'center',
    expandedObjectPosition: 'center 17%',
  },
  {
    ...
    medium: { en: 'Cinematic', ru: 'Кинообраз' },
    animated: true,
    poster: '/avatar/presences/sable-v1/avatar.webp',
    expandedPortrait: '/avatar/presences/sable-v1/expanded.webp',
    expandedFraming: 'upper-body',
    objectPosition: 'center',
    expandedObjectPosition: 'center 17%',
  },
  {
    ...
    medium: { en: 'Cinematic', ru: 'Кинообраз' },
    animated: true,
    poster: '/avatar/presences/iris-v1/avatar.webp',
    expandedPortrait: '/avatar/presences/iris-v1/expanded.webp',
    expandedFraming: 'upper-body',
    objectPosition: 'center',
    expandedObjectPosition: 'center 17%',
  },
