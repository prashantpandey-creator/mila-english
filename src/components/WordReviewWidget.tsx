  ...
  return (
    <div>
      ...
      <div style={{display:'flex',gap:12}}>
        ...
        <button onClick={onKnow} style={{flex:1,padding:'14px',borderRadius:14,border:'none',background:`linear-gradient(135deg,${C.mercuryBright},${C.mercury})`,color:'#031d14',fontWeight:800,cursor:'pointer',fontSize:'1rem'}}>
