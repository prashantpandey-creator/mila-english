...
export default function WeakAreasAlert({ lang }: { lang: 'ru'|'en' }) {
  return (
    <div style={{background:C.goldL,borderRadius:14,padding:'14px 18px',display:'flex',alignItems:'center',gap:12,marginTop:16}}>
      <span style={{fontSize:'1.3rem'}}>💡</span>
      <div>
        <div style={{fontWeight:700,fontSize:'0.85rem',color:C.dark}}>
