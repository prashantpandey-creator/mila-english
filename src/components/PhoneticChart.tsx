  ...
  return (
    <div className="focus-card" style={{padding:'20px',marginTop:16}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:10}}>
        {SOUNDS.map((s,i)=>(
          <div key={i} style={{textAlign:'center',padding:'10px 4px',borderRadius:10,background:SIGNAL_SOFT,border:`1px solid ${SIGNAL}`}}>
            <div style={{fontSize:'1.1rem',fontWeight:700,color:SIGNAL}}>{s.ipa}</div>
