    ...
    <svg viewBox="0 0 64 64" aria-hidden="true" focusable="false">
      <defs>
        ...
        <linearGradient id="mila-bloom-leaf" x1="31" y1="38" x2="51" y2="58" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="1" stopColor="#d9006c" />
        </linearGradient>
      </defs>
      <path d="M33 39c.4 7.6 3.8 12.5 9.9 16.2" fill="none" stroke="#a40050" strokeWidth="2.2" strokeLinecap="round" />
      <path d="M41.2 49.7c5-1.7 9.2-.3 11.1 3.8-5.1 1.9-9.2.5-11.1-3.8Z" fill="url(#mila-bloom-leaf)" stroke="#a40050" strokeWidth="1.2" strokeLinejoin="round" />
      <g fill="url(#mila-bloom-petal)" stroke="#d9006c" strokeWidth="1.25">
      ...
      <circle cx="32" cy="32" r="7.2" fill="#d9006c" stroke="#a40050" strokeWidth="1.35" />
