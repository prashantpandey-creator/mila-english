...
const BASE: CSSProperties = {
  ...
  borderRadius: 18,
  boxShadow: '0 10px 34px rgba(0,0,0,0.48), inset 0 1px 0 rgba(154,242,211,0.035)',
  ...
  return (
    <div
      ...
      onMouseEnter={hover ? (e) => {
        ...
        e.currentTarget.style.borderColor = 'rgba(36,211,154,0.38)';
        e.currentTarget.style.boxShadow = '0 16px 42px rgba(0,0,0,0.54), 0 0 28px rgba(36,211,154,0.07)';
      } : undefined}
...
export function IconTile({ children, size = 44 }: { children: ReactNode; size?: number }) {
  return (
    <div style={{
      ...
      background: 'linear-gradient(145deg, rgba(36,211,154,0.07), rgba(106,220,245,0.025))',
      border: `1px solid ${C.line}`,
