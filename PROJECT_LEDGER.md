...
|------|-------|--------|-------|
| Mia place-first world language experience | **Current Mia direction.** `mia.purangpt.com` now begins with the feeling of a destination rather than a generic phrase form. Jaipur, India and Ubud, Bali lead a six-place cinematic explorer, followed by Tokyo, Lisbon, Mexico City, and Seoul. Choosing a place immediately carries its atmosphere, language mix, everyday cultural cue, suggested real-world moment, matching film, and curated dialogue into the Scene Studio; custom destinations and generated scenes remain available. Bali now has a complete offline Indonesian scene set and native browser speech locale, while the social card and hero connect India and Bali in the same tactile editorial identity. No flags, faces, or country stereotypes were added. | `a3d348e` (2026-07-24) | Deploy run [`30063610827`](https://github.com/prashantpandey-creator/mila-english/actions/runs/30063610827) is green for exact SHA `a3d348eb62a645178dbb36c3bb8217526a1d2cde`. Live HTML contains `Feel the place. Speak its language.`, `India & Bali in focus`, and `Ubud · Bali`; live hashed JS/CSS contain `mia-destinations` and the India/Bali copy. `/mia-og-v2.jpg` returns 200 as `image/jpeg` at 362,577 bytes and is byte-identical to the committed 1200×630 asset (`d3038cb7…`). The [live destination capture](docs/live-proof/mia-destination-world-a3d348e.png) records the desktop layout with Jaipur and Ubud as equal featured doors. All 84 tests, targeted product-isolation checks, TypeScript, and the production build pass. |
